...
import menHero from '@/assets/Models/Arthur Morgen2.png'
import galleryVideo from '@/assets/videos/Bvlgari Octo Finissimo The Ultimate Swiss Made Luxury Watch for Men - Art Of Time.mp4'
import galleryPoster from '@/assets/images/Photos/Rolex Cover Image2.jpg'
import storyImage from '@/assets/images/Photos/Audemars Piguet Cover Image.avif'
    ...
    <PageTransition>
      <div className="collection-detail">
        <section className="collection-hero shop-gender-hero">
          <div className="collection-hero__media" aria-hidden="true" style={{ background: `#1a1512 url(${menHero}) no-repeat 33% 20% / cover` }}>
            <img className="collection-hero__image" src={menHero} alt="Men's Watches" />
          </div>
          <div className="collection-hero__overlay" aria-hidden="true" />
          <div className="collection-hero__content">
            <p className="collection-hero__eyebrow">{t('shop.mensCollection')}</p>
            <h1 className="collection-hero__title">{t('shop.mensTitle')}</h1>
            <p className="collection-hero__description">{t('shop.mensSubtitle')}</p>
          ...
          <div className="collection-section__inner collection-story__layout">
            <div className="collection-story__content">
              ...
              <p className="collection-section__body">
                {t('collection.storyBody1', { name: t('shop.mensCollection') })}
              </p>
              <p className="collection-section__body">
            ...
            <div className="collection-story__media">
              <img className="collection-story__image" src={storyImage} alt="Men's editorial" />
            </div>
          </div>
        </motion.section>
        ...
        <motion.section className="collection-section collection-motion" aria-labelledby="collection-motion" {...sectionRevealProps}>
          <div className="collection-section__inner collection-motion__layout">
            <div className="collection-motion__content">
              ...
              <Button to="/shop/men" variant="secondary">
